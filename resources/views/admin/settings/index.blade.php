<x-admin-layout>
    <div class="py-6">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <!-- Page Header -->
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">{{ __('Site Settings') }}</h1>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">{{ __('Manage site-wide configuration and settings') }}</p>
            </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input 
                                ...
                                autofocus
                            />
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('The name of your site') }}</p>
                        ...
                        <div>
                            ...
                            @if($settings['site_logo'] ?? null)
                                <div class="mt-2 mb-4">
                                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">{{ __('Current Logo') }}:</p>
                            ...
                            >
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('Upload a new logo (max 2MB, recommended: PNG or SVG)') }}</p>
                            
                            <!-- Preview for new upload -->
                            <div id="logo-preview-container" class="mt-2 hidden">
                                <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">{{ __('Preview') }}:</p>
                                <div class="inline-block p-2 bg-gray-100 dark:bg-gray-700 rounded-lg">
                                    <img id="logo-preview" src="" alt="{{ __('Logo Preview') }}" class="h-20 w-auto object-contain">
                                </div>
                            </div>
                        ...
                        <!-- Default Language -->
                        <div>
                            <x-input-label for="default_language_code" :value="__('Default Language')" />
                            <select 
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('The default language for your site') }}</p>
                            <x-input-error :messages="$errors->get('default_language_code')" class="mt-2" />
                        </div>

                        <!-- Site Email -->
                        <div>
                            <x-input-label for="site_email" :value="__('Site Email')" />
                            <x-text-input 
                                id="site_email" 
                                name="site_email" 
                                type="email" 
                            ...
                            />
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('Contact email address for the site') }}</p>
                            <x-input-error :messages="$errors->get('site_email')" class="mt-2" />
                        </div>

                        <!-- Site Phone -->
                        <div>
                            <x-input-label for="site_phone" :value="__('Site Phone')" />
                            <x-text-input 
                                id="site_phone" 
                                name="site_phone" 
                                type="text" 
                            ...
                            />
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('Contact phone number for the site') }}</p>
                            <x-input-error :messages="$errors->get('site_phone')" class="mt-2" />
                        </div>

                        <!-- Site Address -->
                        <div>
                            <x-input-label for="site_address" :value="__('Site Address')" />
                            <textarea 
                                id="site_address" 
                                name="site_address" 
                                rows="3"
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('Physical address of your organization') }}</p>
            ...
            <div class="mt-6 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                <div class="flex">
                    ...
                    <div class="text-sm text-blue-800 dark:text-blue-300">
                        <p class="font-medium mb-1">{{ __('Settings Information') }}</p>
                        <ul class="list-disc list-inside space-y-1">
                            <li>{{ __('Changes to site settings will be applied immediately') }}</li>
                            <li>{{ __('Logo images should be in PNG, JPG, or SVG format') }}</li>
                            <li>{{ __('The default language will be used for new users and the site homepage') }}</li>
                            <li>{{ __('Contact information is displayed publicly on the site') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
