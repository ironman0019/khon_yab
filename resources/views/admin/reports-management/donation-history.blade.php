    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex justify-between items-center">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">{{ __('Donation History Report') }}</h1>
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">{{ __('View donation history per individual donor') }}</p>
                </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 mb-6">
                <form method="GET" action="{{ route('admin.reports-management.donation-history') }}" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <!-- Donor -->
                    <div>
                        <label for="donor_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{{ __('Donor') }}</label>
                        <select id="donor_id" name="donor_id" 
                            ...
                            <option value="">{{ __('All Donors') }}</option>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('Total Amount (ml)') }}</p>
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ number_format($total_amount_ml) }} ml</p>
                </div>
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('Unique Donors') }}</p>
