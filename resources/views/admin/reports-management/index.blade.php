<x-admin-layout>
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Page Header -->
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">{{ __('Reports Management') }}</h1>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">{{ __('View and export various system reports') }}</p>
            </div>
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 mb-8">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('Donations This Month') }}</p>
                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            <div class="flex items-center mb-4">
                                ...
                                <h3 class="ml-3 text-lg font-semibold text-gray-900 dark:text-white">{{ __('Active Donors') }}</h3>
                            </div>
                            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">{{ __('View all active donors with ability to donate') }}</p>
                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            <div class="flex items-center mb-4">
                                ...
                                <h3 class="ml-3 text-lg font-semibold text-gray-900 dark:text-white">{{ __('Blood Inventory') }}</h3>
                            </div>
                            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">{{ __('View current blood inventory status') }}</p>
                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            <div class="flex items-center mb-4">
                                ...
                                <h3 class="ml-3 text-lg font-semibold text-gray-900 dark:text-white">{{ __('Blood Shortage') }}</h3>
                            </div>
                            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">{{ __('View blood types with low stock') }}</p>
                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            <div class="flex items-center mb-4">
                                ...
                                <h3 class="ml-3 text-lg font-semibold text-gray-900 dark:text-white">{{ __('Approved Requests') }}</h3>
                            </div>
                            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">{{ __('View all approved blood requests') }}</p>
                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            <div class="flex items-center mb-4">
                                ...
                                <h3 class="ml-3 text-lg font-semibold text-gray-900 dark:text-white">{{ __('Donation History') }}</h3>
                            </div>
                            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">{{ __('View donation history per individual') }}</p>
                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            <div class="flex items-center mb-4">
                                ...
                                <h3 class="ml-3 text-lg font-semibold text-gray-900 dark:text-white">{{ __('By Province') }}</h3>
                            </div>
                            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">{{ __('View reports filtered by province') }}</p>
                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            <div class="flex items-center mb-4">
                                ...
                                <h3 class="ml-3 text-lg font-semibold text-gray-900 dark:text-white">{{ __('Monthly/Yearly') }}</h3>
                            </div>
                            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">{{ __('View aggregated monthly and yearly reports') }}</p>
                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            <div class="flex items-center mb-4">
                                ...
                                <h3 class="ml-3 text-lg font-semibold text-gray-900 dark:text-white">{{ __('Bag Expiration') }}</h3>
                            </div>
                            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">{{ __('View expiring and expired blood bags') }}</p>
