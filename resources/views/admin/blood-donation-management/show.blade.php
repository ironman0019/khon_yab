            ...
            <div class="mb-6 flex {{ $isRtl ? 'flex-row-reverse' : '' }} justify-between items-center">
                ...
                <div class="flex {{ $isRtl ? 'flex-row-reverse' : '' }} gap-2">
                    ...
                    @if($donationRecord->status == 0 && !$donationRecord->bloodTest)
                        <a href="{{ route('admin.blood-donation-management.test.create', $donationRecord) }}" 
                    ...
                    @if($donationRecord->bloodTest && $donationRecord->status != 3)
                        <a href="{{ route('admin.blood-donation-management.test.edit', $donationRecord) }}" 
                           class="inline-flex items-center {{ $isRtl ? 'flex-row-reverse' : '' }} px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-lg transition-colors">
                            <svg class="w-5 h-5 {{ $isRtl ? 'ml-2' : 'mr-2' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.blood-donation-management.print', $donationRecord) }}" 
                       target="_blank"
                    ...
                    <a href="{{ route('admin.blood-donation-management.edit', $donationRecord) }}" 
                    ...
                    <form method="POST" 
                          action="{{ route('admin.blood-donation-management.destroy', $donationRecord) }}" 
                          class="inline"
