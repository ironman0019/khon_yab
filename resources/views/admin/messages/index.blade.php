...
@endphp
<x-admin-layout>
    <div class="h-[calc(100vh-4rem)] flex flex-col" data-unread-count="{{ $unreadCount }}">
        ...
        <div class="flex-1 flex overflow-hidden">
            ...
            <div class="w-full md:w-[350px] flex flex-col border-r border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
                ...
                <div class="h-16 px-4 flex items-center justify-between border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
                    <h1 class="text-lg font-semibold text-gray-900 dark:text-white">{{ __('admin.Messages') }}</h1>
                    <a href="{{ route('admin.messages.create') }}" 
                       class="p-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
                       title="{{ __('admin.New Message') }}">
                ...
                <div class="px-3 py-2 bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
                    <div class="relative">
                        ...
                        <input 
                            ...
                            placeholder="{{ __('admin.Search conversations...') }}"
                        >
                    </div>
                </div>
                ...
                <div class="flex-1 overflow-y-auto" id="conversations-list">
                    @forelse($conversations as $conversation)
                        <a href="{{ route('admin.messages.show', $conversation['partner']->id) }}" 
                    ...
                    @empty
                        <div class="px-4 py-12 text-center">
                            ...
                            <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('admin.No conversations') }}</h3>
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('admin.Get started by sending a new message.') }}</p>
                        </div>
                    @endforelse
                </div>
            </div>
            ...
            <div class="hidden md:flex flex-1 flex-col items-center justify-center bg-gray-50 dark:bg-gray-900">
                <div class="text-center px-4">
                    ...
                    <h3 class="mt-4 text-lg font-medium text-gray-900 dark:text-white">{{ __('admin.Select a conversation') }}</h3>
                    <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">{{ __('admin.Choose a conversation from the list to start messaging') }}</p>
                </div>
            </div>
        </div>
    </div>
