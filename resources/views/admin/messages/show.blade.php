...
<x-admin-layout>
        ...
        <div class="flex-1 flex overflow-hidden">
            ...
            <div class="flex-1 flex flex-col bg-gray-50 dark:bg-gray-900">
                    ...
                    @empty
                        <div class="flex items-center justify-center h-full">
                            <div class="text-center">
                                ...
                                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">{{ __('admin.No messages yet') }}</p>
                            </div>
                        </div>
                    @endforelse
                </div>
                ...
                <div class="border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-4">
                    <form method="POST" action="{{ route('admin.messages.store') }}" class="flex {{ $isRtl ? 'flex-row-reverse' : '' }} items-end gap-2">
                        @csrf
    ...
    <script>
        (function() {
            ...
            const fetchMessagesUrl = '{{ route('admin.messages.fetch', $user->id) }}';
            ...
            function updateConversationsList(conversations) {
                ...
                conversations.forEach(function(conv) {
                    ...
                    const itemHtml = `
                        <a href="/admin/messages/${partner.id}" 
            ...
            function startPolling() {
                ...
                pollingInterval = setInterval(fetchNewMessages, 2500); // Poll every 2.5 seconds
            }
