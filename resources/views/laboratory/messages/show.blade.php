...
<x-app-layout>
        ...
        <div class="flex-1 flex overflow-hidden">
            ...
            <div class="flex-1 flex flex-col bg-gray-50 dark:bg-gray-900">
                ...
                <div class="border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-4">
                    <form method="POST" action="{{ route('laboratory.messages.store') }}" class="flex {{ $isRtl ? 'flex-row-reverse' : '' }} items-end gap-2">
                        @csrf
    ...
    <script>
        (function() {
            ...
            const fetchMessagesUrl = '{{ route('laboratory.messages.fetch', $user->id) }}';
            const fetchConversationsUrl = '{{ route('laboratory.messages.conversations.fetch') }}';
            const storeMessageUrl = '{{ route('laboratory.messages.store') }}';
            ...
            function updateConversationsList(conversations) {
                ...
                conversations.forEach(function(conv) {
                    ...
                    const itemHtml = `
                        <a href="/laboratory/messages/${partner.id}" 
