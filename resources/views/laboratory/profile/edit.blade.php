...
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('laboratory.Edit Hospital Profile') }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 {{ $isRtl ? 'text-right' : 'text-left' }}">
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">{{ __('laboratory.Edit Hospital Profile') }}</h1>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">{{ __('laboratory.Update your hospital information') }}</p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                <form method="POST" action="{{ route($updateRoute ?? 'laboratory.profile.update') }}"
                      x-data="{ 
                          cities: @js($cities),
                          init() {
                    ...
                    <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-4 {{ $isRtl ? 'text-right' : 'text-left' }}">{{ __('laboratory.Hospital Information') }}</h2>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 pb-6 border-b border-gray-200 dark:border-gray-700">
                        <!-- Hospital Name -->
                        <div>
                            <x-input-label for="laboratory_name" :value="__('laboratory.Hospital Name')" />
                            <x-text-input 
                                id="laboratory_name" 
                        ...
                        <!-- Hospital Code -->
                        <div>
                            <x-input-label for="laboratory_code" :value="__('laboratory.Hospital Code')" />
                            <x-text-input 
                                id="laboratory_code" 
                        ...
                        <!-- License Number -->
                        <div>
                            <x-input-label for="license_number" :value="__('laboratory.License Number')" />
                            <x-text-input 
                                id="license_number" 
                                name="license_number" 
                                type="text" 
                        ...
                        <!-- Contact Person Name -->
                        <div>
                            <x-input-label for="contact_person_name" :value="__('laboratory.Contact Person Name')" />
                            <x-text-input 
                    ...
                    <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-4 {{ $isRtl ? 'text-right' : 'text-left' }}">{{ __('laboratory.Contact Information') }}</h2>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 pb-6 border-b border-gray-200 dark:border-gray-700">
                        <!-- Mobile Number -->
                        <div>
                            <x-input-label for="mobile_number" :value="__('laboratory.Mobile Number')" />
                            <x-text-input 
                                id="mobile_number" 
                                name="mobile_number" 
                                type="text" 
                        ...
                        <!-- Phone Number -->
                        <div>
                            <x-input-label for="phone_number" :value="__('laboratory.Phone Number')" />
                            <x-text-input 
                                id="phone_number" 
                                name="phone_number" 
                                type="text" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 pb-6 border-b border-gray-200 dark:border-gray-700">
                        ...
                        <div class="md:col-span-2">
                            <x-input-label for="address" :value="__('laboratory.Address')" />
                            <x-textarea 
                                id="address" 
                                name="address" 
                                class="block mt-1 w-full border-red-300 focus:border-red-500 focus:ring-red-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                                rows="3"
                                required
                            >{{ old('address', $laboratory->address) }}</x-textarea>
                    ...
                    <div class="flex {{ $isRtl ? 'flex-row-reverse justify-start' : 'justify-end' }} gap-4">
                        <a href="{{ route('laboratory.dashboard.index') }}" 
