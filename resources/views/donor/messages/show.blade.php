...
<x-app-layout>
        ...
        <div class="flex-1 flex overflow-hidden">
            ...
            <div class="hidden md:flex w-[350px] flex-col border-r border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
                ...
                <div class="h-16 px-4 flex items-center justify-between border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
                    <h1 class="text-lg font-semibold text-gray-900 dark:text-white">{{ __('donor.Messages') }}</h1>
                    <a href="{{ route('donor.messages.create') }}" 
                       class="p-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
                       title="{{ __('donor.New Message') }}">
                ...
                <div class="px-3 py-2 bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
                    <div class="relative">
                        ...
                        <input 
                            ...
                            placeholder="{{ __('donor.Search conversations...') }}"
                        >
                    </div>
                </div>
            ...
            <div class="flex-1 flex flex-col bg-gray-50 dark:bg-gray-900">
                    ...
                    @empty
                        <div class="flex items-center justify-center h-full">
                            <div class="text-center">
                                ...
                                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">{{ __('donor.No messages yet') }}</p>
                            </div>
                        </div>
                    @endforelse
                </div>
                ...
                <div class="border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-4">
                    <form method="POST" action="{{ route('donor.messages.store') }}" class="flex {{ $isRtl ? 'flex-row-reverse' : '' }} items-end gap-2">
                        @csrf
    ...
    <script>
        (function() {
            ...
            const fetchMessagesUrl = '{{ route('donor.messages.fetch', $user->id) }}';
            const fetchConversationsUrl = '{{ route('donor.messages.conversations.fetch') }}';
            const storeMessageUrl = '{{ route('donor.messages.store') }}';
            ...
            function updateConversationsList(conversations) {
                ...
                conversations.forEach(function(conv) {
                    ...
                    const itemHtml = `
                        <a href="/donor/messages/${partner.id}" 
