        ...
        <div class="flex-1 flex overflow-hidden">
            ...
            <div class="hidden md:flex flex-1 flex-col items-center justify-center bg-gray-50 dark:bg-gray-900">
                <div class="text-center px-4">
                    ...
                    <h3 class="mt-4 text-lg font-medium text-gray-900 dark:text-white">{{ __('donor.Select a conversation') }}</h3>
                    <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">{{ __('donor.Choose a conversation from the list to start messaging') }}</p>
                </div>
            </div>
        </div>
    </div>
