                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow">
                            ...
                            <div class="space-y-2 mb-4">
                                ...
                                <div class="flex items-center {{ $isRtl ? 'flex-row-reverse' : '' }} gap-2 text-sm text-gray-600 dark:text-gray-300">
                                    ...
                                    @php
                                        // Clean phone number: remove spaces, dashes, parentheses, and other non-numeric characters except +
                                        $cleanPhone = preg_replace('/[^0-9+]/', '', $request->contact_number);
                                        // If phone doesn't start with +, assume it's a local number and add country code (default to +93 for Afghanistan)
                                        // You can adjust this based on your country
                                    ...
                                    <a 
                                        ...
                                        class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-green-500 hover:bg-green-600 text-white transition-colors ml-2 {{ $isRtl ? 'mr-2 ml-0' : '' }}"
                                        title="{{ __('home.Contact via WhatsApp') }}"
                                    >
