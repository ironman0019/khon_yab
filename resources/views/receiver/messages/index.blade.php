        ...
        <div class="flex-1 flex overflow-hidden">
                ...
                <div class="flex-1 overflow-y-auto" id="conversations-list">
                    ...
                    @empty
                        <div class="px-4 py-12 text-center">
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ __('receiver.Get started by sending a new message.') }}</p>
                        </div>
                    @endforelse
                </div>
            </div>
            ...
            <div class="hidden md:flex flex-1 flex-col items-center justify-center bg-gray-50 dark:bg-gray-900">
                <div class="text-center px-4">
                    ...
                    <h3 class="mt-4 text-lg font-medium text-gray-900 dark:text-white">{{ __('receiver.Select a conversation') }}</h3>
                    <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">{{ __('receiver.Choose a conversation from the list to start messaging') }}</p>
                </div>
            </div>
        </div>
    </div>
