...
class UpdateBloodTestRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'hiv_result' => ['sometimes', 'required', 'integer', Rule::in([0, 1])],
            'hbv_result' => ['sometimes', 'required', 'integer', Rule::in([0, 1])],
            'hcv_result' => ['sometimes', 'required', 'integer', Rule::in([0, 1])],
            'syphilis_result' => ['sometimes', 'required', 'integer', Rule::in([0, 1])],
            'malaria_result' => ['sometimes', 'required', 'integer', Rule::in([0, 1])],
            'test_date' => ['sometimes', 'required', 'date'],
            'test_logs' => ['sometimes', 'nullable', 'string'],
        ];
    }
