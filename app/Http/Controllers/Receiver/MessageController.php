...
{
    /**
     * Display a listing of the receiver's conversations.
     */
    public function index(): View
    {
        ...
        return view('receiver.messages.index', compact('conversations'));
    }
    ...
    public function show(User $user): View
    {
        ...
        return view('receiver.messages.show', compact('messages', 'user', 'conversations'));
    }
    ...
    {
        return view('receiver.messages.create');
    }
    ...
    public function store(StoreMessageRequest $request): RedirectResponse|JsonResponse
    {
        ...
        return redirect()->route('receiver.messages.show', $recipient->id)
