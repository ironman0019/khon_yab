...
{
    /**
     * Display a listing of the laboratory's conversations.
     */
    public function index(): View
    {
        ...
        return view('laboratory.messages.index', compact('conversations'));
    }
    ...
    public function show(User $user): View
    {
        ...
        return view('laboratory.messages.show', compact('messages', 'user', 'conversations'));
    }
    ...
    {
        return view('laboratory.messages.create');
    }
    ...
    public function store(StoreMessageRequest $request): RedirectResponse|JsonResponse
    {
        ...
        return redirect()->route('laboratory.messages.show', $recipient->id)
